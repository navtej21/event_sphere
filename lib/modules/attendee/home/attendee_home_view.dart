...
import 'package:event_sphere/modules/attendee/account/account_page.dart';
import 'package:event_sphere/modules/attendee/bottombar/bottom_navigation_bar.dart';
import 'package:event_sphere/modules/attendee/eventdashboard/event_discover_page.dart';
import 'package:event_sphere/modules/attendee/favorite/attendee_favorite_view.dart';
import 'package:event_sphere/modules/attendee/tickets/ticket_page_view.dart';
...
class _AttendeeScreenState extends State<AttendeeScreen> {
  ...
  final _pages= [
    const EventDiscoverPage(),
    const AttendeeFavoriteView(),
